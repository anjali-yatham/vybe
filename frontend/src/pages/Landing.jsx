...
function Landing() {
  ...
  return (
    <div className="relative bg-black min-h-screen">
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 right-0 z-50 pt-6 px-6 md:px-12">
      ...
      <section className="relative z-10 bg-gradient-to-b from-gray-900 via-black to-black py-24 px-6">
        <motion.div
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center mb-6 border border-purple-500/30">
            ...
            <motion.div
              ...
              className="flex flex-col items-center text-center"
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500/20 to-orange-500/20 flex items-center justify-center mb-6 border border-pink-500/30">
            ...
            <motion.div
              ...
              className="flex flex-col items-center text-center"
            >
              <div className="w-16 h-16 rounded-full bg-gradient-to-br from-orange-500/20 to-yellow-500/20 flex items-center justify-center mb-6 border border-orange-500/30">
      ...
      <section className="relative z-10 bg-black py-24 px-6">
        ...
        >
          <p className="text-sm md:text-base text-green-400 font-medium tracking-wider uppercase mb-4">
            The Guarantee
          </p>
          ...
          <button
            onClick={() => navigate('/signup')}
            className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-all hover:scale-105"
          >
            Get Started
          </button>
        </motion.div>
      ...
      {/* CTA Banner Section */}
      <section className="relative z-10 bg-gradient-to-b from-black to-gray-900 py-16 px-6">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          ...
          className="max-w-6xl mx-auto"
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-3xl p-8 md:p-12 border border-purple-500/20">
            ...
            <button
              ...
              className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white px-8 py-4 rounded-full font-semibold text-lg hover:opacity-90 transition-all hover:scale-105 whitespace-nowrap"
            >
              List a Ticket
            </button>
          </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-gray-950 border-t border-white/10">
        {/* Main Footer Content */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-yellow-300 text-xs ml-0.5">✦</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <button onClick={() => navigate('/about')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Who We Are
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/how-it-works')} className="text-white/60 hover:text-white transition-colors text-sm">
                    How It Works
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/careers')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Careers
                  </button>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <button onClick={() => navigate('/support')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Support Center
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/buying-guide')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Buying Guide
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/selling-guide')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Selling Guide
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/verify')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Verify a Ticket
                  </button>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <button onClick={() => navigate('/terms')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Terms of Service
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/privacy')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Privacy Policy
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/disputes')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Dispute Resolution
                  </button>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <button onClick={() => navigate('/customer-service')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Customer Service
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/press')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Press
                  </button>
                </li>
                <li>
                  <button onClick={() => navigate('/partnerships')} className="text-white/60 hover:text-white transition-colors text-sm">
                    Partnerships
                  </button>
                </li>
              </ul>
